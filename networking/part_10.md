...
Недостатки:
1. Алгоритм не обеспечивает прямую секретность - злоумышленник получает доступ к секретному ключу
...
<div>
  <img width="550" height="280" src="src3/img10.png" alt="">
</div>
...
* верхний - определяет, какое содержание будет передаваться
  ...
  - протокол оповещения (alert protocol) - для отправки сообещний об ошибках
  - протокол смены шифра (change ciper protocol) - для перехода от одного вида шифрования к другому
