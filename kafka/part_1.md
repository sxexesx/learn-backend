...
- At most once (X ≤ 1) - доставим или не доставим, но повторять не будем
- At least once (X ≥ 1) - сообщение приняли, доставим еще раз, если не уверены, что доставили
- Exactly once (X ~ 1) - доставим точно один раз. 
